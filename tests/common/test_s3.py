...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3.create_bucket(Bucket=self.s3_bucket_name, CreateBucketConfiguration={"LocationConstraint":"us-east-1"})
    ...
    def tearDown(self):
        ...
        """
        # mocking s2 connection stop
        self.mock_s3.stop()

    def test_list_files_in_prefix_ok(self):
        """
        Tests the list_files_in_prefix method for getting 2 files keys as list on the mocked s3 bucket
        """
        # Expected results
        prefix_exp = "prefix/"
